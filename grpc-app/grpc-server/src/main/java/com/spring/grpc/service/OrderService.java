...
import com.spring.grpc.handler.OrderHandler;
...
public class OrderService extends OrderServiceGrpc.OrderServiceImplBase {
    ...
    public void getOrderStatus(OrderKey request, StreamObserver<com.proto.app.OrderStatus> responseObserver) {
        ...
        try {
            List<OrderStatus> status = orderHandler
                    .getOrderStatusByUserNameOrOrderId(request.getUserName(), request.getOrderId());
    ...
    public void specialCaseSimulator(SimRequest request, StreamObserver<SimResponse> responseObserver) {
        ...
        if(simulateServerInterruption){
            ...
            log.info("generated random number {}",randNum);
            if (randNum >= 7 ) { // 30 % failure simulation
